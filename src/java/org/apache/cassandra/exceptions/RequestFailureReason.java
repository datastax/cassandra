...
public enum RequestFailureReason
{
    ...
    INDEX_VERSION_TOO_OLD    (504); // The index uses an old version that doesn't support the requested feature
    ...
    static
    {
        ...
        exceptionToReasonMap.put(IndexVersionTooOldException.class, INDEX_VERSION_TOO_OLD);
