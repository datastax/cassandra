    ...
    public DataSet data()
    {
        ...
        Nodes.peers()
             ...
             .forEach(p -> {
                 ...
                 dataset.row(peerInfo.getPeerAddressAndPort().getAddress(), peerInfo.getPeerAddressAndPort().getPort())
                        //+ "preferred_ip inet,"
                        .column("preferred_ip",
                        ...
                        .column("preferred_port",
                                peerInfo.getPreferredAddressAndPort() == null ? null : peerInfo.getPreferredAddressAndPort().getPort())
                        //+ "native_address inet,"
                       ...
                       .column("native_port",
                               peerInfo.getNativeTransportAddressAndPort() == null ? null
                                                                            : peerInfo.getNativeTransportAddressAndPort().getPort());
