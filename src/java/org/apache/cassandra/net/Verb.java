...
public class Verb
{
    ...
    public static Verb BATCH_REMOVE_REQ       = new Verb("BATCH_REMOVE_REQ",       6,   P3, writeTimeout,    MUTATION,          () -> TimeUUID.Serializer.instance,         () -> BatchRemoveVerbHandler.instance,     BATCH_REMOVE_RSP    );
    ...
    public static Verb PAXOS_COMMIT_REQ       = new Verb("PAXOS_COMMIT_REQ",       35,  P2, writeTimeout,    MUTATION,          () -> Agreed.serializer,                    () -> PaxosCommit.requestHandler,          PAXOS_COMMIT_RSP    );
    ...
    public static Verb GOSSIP_SHUTDOWN        = new Verb("GOSSIP_SHUTDOWN",        29,  P0, rpcTimeout,      GOSSIP,            () -> GossipShutdown.serializer,            () -> GossipShutdownVerbHandler.instance                       );
    ...
    public static Verb REPAIR_RSP             = new Verb("REPAIR_RSP",             100, P1, repairTimeout,   REQUEST_RESPONSE,  () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                             );
    public static Verb VALIDATION_RSP         = new Verb("VALIDATION_RSP",         102, P1, repairValidationRspTimeout, ANTI_ENTROPY, () -> ValidationResponse.serializer,  () -> RepairMessageVerbHandler.instance(), REPAIR_RSP          );
    ...
    public static Verb PREPARE_CONSISTENT_REQ = new Verb("PREPARE_CONSISTENT_REQ", 108, P1, repairWithBackoffTimeout, ANTI_ENTROPY,      () -> PrepareConsistentRequest.serializer,  () -> RepairMessageVerbHandler.instance(), REPAIR_RSP          );
    public static Verb FINALIZE_PROPOSE_MSG   = new Verb("FINALIZE_PROPOSE_MSG",   110, P1, repairWithBackoffTimeout, ANTI_ENTROPY,      () -> FinalizePropose.serializer,           () -> RepairMessageVerbHandler.instance(), REPAIR_RSP          );
    public static Verb FINALIZE_PROMISE_MSG   = new Verb("FINALIZE_PROMISE_MSG",   111, P1, repairWithBackoffTimeout, ANTI_ENTROPY,      () -> FinalizePromise.serializer,           () -> RepairMessageVerbHandler.instance(), REPAIR_RSP          );
    public static Verb FINALIZE_COMMIT_MSG    = new Verb("FINALIZE_COMMIT_MSG",    112, P1, repairWithBackoffTimeout, ANTI_ENTROPY,      () -> FinalizeCommit.serializer,            () -> RepairMessageVerbHandler.instance(), REPAIR_RSP          );
    public static Verb FAILED_SESSION_MSG     = new Verb("FAILED_SESSION_MSG",     113, P1, repairWithBackoffTimeout, ANTI_ENTROPY,      () -> FailSession.serializer,               () -> RepairMessageVerbHandler.instance(), REPAIR_RSP          );
    ...
    public static Verb STATUS_REQ             = new Verb("STATUS_REQ",             114, P1, repairTimeout,   ANTI_ENTROPY,      () -> StatusRequest.serializer,             () -> RepairMessageVerbHandler.instance(), REPAIR_RSP          );
    ...
    public static Verb PAXOS2_COMMIT_REMOTE_REQ=new Verb("PAXOS2_COMMIT_REMOTE_REQ",38, P2, writeTimeout,    MUTATION,          () -> Mutation.serializer,                  () -> MutationVerbHandler.instance,        MUTATION_RSP        );
    public static Verb PAXOS2_COMMIT_REMOTE_RSP=new Verb("PAXOS2_COMMIT_REMOTE_RSP",39, P2, writeTimeout,    REQUEST_RESPONSE,  () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                             );
    public static Verb PAXOS2_PREPARE_RSP     = new Verb("PAXOS2_PREPARE_RSP",     50,  P2, writeTimeout,    REQUEST_RESPONSE,  () -> PaxosPrepare.responseSerializer,      () -> ResponseVerbHandler.instance                             );
    public static Verb PAXOS2_PREPARE_REQ     = new Verb("PAXOS2_PREPARE_REQ",     40,  P2, writeTimeout,    MUTATION,          () -> PaxosPrepare.requestSerializer,       () -> PaxosPrepare.requestHandler,         PAXOS2_PREPARE_RSP  );
    public static Verb PAXOS2_PREPARE_REFRESH_RSP= new Verb("PAXOS2_PREPARE_REFRESH_RSP", 51, P2, writeTimeout, REQUEST_RESPONSE,  () -> PaxosPrepareRefresh.responseSerializer,  () -> ResponseVerbHandler.instance                       );
    public static Verb PAXOS2_PREPARE_REFRESH_REQ= new Verb("PAXOS2_PREPARE_REFRESH_REQ", 41, P2, writeTimeout, MUTATION,       () -> PaxosPrepareRefresh.requestSerializer,() -> PaxosPrepareRefresh.requestHandler,  PAXOS2_PREPARE_REFRESH_RSP);
    public static Verb PAXOS2_PROPOSE_RSP     = new Verb("PAXOS2_PROPOSE_RSP",     52,  P2, writeTimeout,    REQUEST_RESPONSE,  () -> PaxosPropose.responseSerializer,      () -> ResponseVerbHandler.instance                             );
    public static Verb PAXOS2_PROPOSE_REQ     = new Verb("PAXOS2_PROPOSE_REQ",     42,  P2, writeTimeout,    MUTATION,          () -> PaxosPropose.requestSerializer,       () -> PaxosPropose.requestHandler,         PAXOS2_PROPOSE_RSP  );
    public static Verb PAXOS2_COMMIT_AND_PREPARE_RSP= new Verb("PAXOS2_COMMIT_AND_PREPARE_RSP", 53, P2, writeTimeout, REQUEST_RESPONSE, () -> PaxosPrepare.responseSerializer, () -> ResponseVerbHandler.instance                          );
    public static Verb PAXOS2_COMMIT_AND_PREPARE_REQ= new Verb("PAXOS2_COMMIT_AND_PREPARE_REQ", 43, P2, writeTimeout, MUTATION, () -> PaxosCommitAndPrepare.requestSerializer, () -> PaxosCommitAndPrepare.requestHandler, PAXOS2_COMMIT_AND_PREPARE_RSP    );
    public static Verb PAXOS2_REPAIR_RSP                = new Verb("PAXOS2_REPAIR_RSP", 54, P2, writeTimeout,  PAXOS_REPAIR,    () -> PaxosRepair.responseSerializer,       () -> ResponseVerbHandler.instance                             );
    public static Verb PAXOS2_REPAIR_REQ                = new Verb("PAXOS2_REPAIR_REQ", 44, P2, writeTimeout,  PAXOS_REPAIR,    () -> PaxosRepair.requestSerializer,        () -> PaxosRepair.requestHandler,          PAXOS2_REPAIR_RSP   );
    public static Verb PAXOS2_CLEANUP_START_PREPARE_RSP = new Verb("PAXOS2_CLEANUP_START_PREPARE_RSP", 55, P2, repairTimeout, PAXOS_REPAIR, () -> PaxosCleanupHistory.serializer, () -> ResponseVerbHandler.instance                       );
    public static Verb PAXOS2_CLEANUP_START_PREPARE_REQ = new Verb("PAXOS2_CLEANUP_START_PREPARE_REQ", 45, P2, repairTimeout, PAXOS_REPAIR, () -> PaxosStartPrepareCleanup.serializer, () -> PaxosStartPrepareCleanup.verbHandler, PAXOS2_CLEANUP_START_PREPARE_RSP );
    public static Verb PAXOS2_CLEANUP_RSP               = new Verb("PAXOS2_CLEANUP_RSP", 56, P2, repairTimeout, PAXOS_REPAIR,   () -> NoPayload.serializer,                 () -> ResponseVerbHandler.instance                             );
    public static Verb PAXOS2_CLEANUP_REQ               = new Verb("PAXOS2_CLEANUP_REQ", 46, P2, repairTimeout, PAXOS_REPAIR,   () -> PaxosCleanupRequest.serializer,       () -> PaxosCleanupRequest.verbHandler,     PAXOS2_CLEANUP_RSP  );
    public static Verb PAXOS2_CLEANUP_RSP2              = new Verb("PAXOS2_CLEANUP_RSP2", 57, P2, repairTimeout, PAXOS_REPAIR,  () -> PaxosCleanupResponse.serializer,      () -> PaxosCleanupResponse.verbHandler                         );
    public static Verb PAXOS2_CLEANUP_FINISH_PREPARE_RSP= new Verb("PAXOS2_CLEANUP_FINISH_PREPARE_RSP", 58, P2, repairTimeout, PAXOS_REPAIR, () -> NoPayload.serializer,    () -> ResponseVerbHandler.instance                             );
    public static Verb PAXOS2_CLEANUP_FINISH_PREPARE_REQ= new Verb("PAXOS2_CLEANUP_FINISH_PREPARE_REQ", 47, P2, repairTimeout, IMMEDIATE, () -> PaxosCleanupHistory.serializer, () -> PaxosFinishPrepareCleanup.verbHandler, PAXOS2_CLEANUP_FINISH_PREPARE_RSP);
    public static Verb PAXOS2_CLEANUP_COMPLETE_RSP      = new Verb("PAXOS2_CLEANUP_COMPLETE_RSP", 59, P2, repairTimeout, PAXOS_REPAIR, () -> NoPayload.serializer,          () -> ResponseVerbHandler.instance                             );
    public static Verb PAXOS2_CLEANUP_COMPLETE_REQ      = new Verb("PAXOS2_CLEANUP_COMPLETE_REQ", 48, P2, repairTimeout, PAXOS_REPAIR, () -> PaxosCleanupComplete.serializer, () -> PaxosCleanupComplete.verbHandler,  PAXOS2_CLEANUP_COMPLETE_RSP);
    ...
    public static Verb _SAMPLE                = new Verb("_SAMPLE",                49,  P1, rpcTimeout,      INTERNAL_RESPONSE, () -> NoPayload.serializer,                 () -> null                                                     );
...
class VerbTimeouts
{
    ...
    static final ToLongFunction<TimeUnit> prepareWithBackoffTimeout    = units -> {
        if (!DatabaseDescriptor.getRepairRetrySpec().isEnabled())
            return prepareTimeout.applyAsLong(units);
        return rpcTimeout.applyAsLong(units);
    };
