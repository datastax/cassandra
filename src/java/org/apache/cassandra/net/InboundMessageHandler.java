...
public class InboundMessageHandler extends AbstractMessageHandler
{
    ...
    private void dispatch(ProcessMessage task)
    {
        ...
        if (state != null) state.trace("{} message received from {}; stage {}: pending {}, active: {}", header.verb, header.from, header.verb.stage, header.verb.stage.getPendingTaskCount(), header.verb.stage.getActiveTaskCount());
