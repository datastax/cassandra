...
public class Config
{
    ...
    public volatile DurationSpec.LongMillisecondsBound hints_request_timeout = new DurationSpec.LongMillisecondsBound("2000ms");
    ...
    public boolean uuid_sstable_identifiers_enabled = true;
