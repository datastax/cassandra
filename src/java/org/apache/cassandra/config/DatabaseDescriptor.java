...
public class DatabaseDescriptor
{
    ...
    static void checkForLowestAcceptedTimeouts(Config conf)
    {
        ...
        if(conf.aggregated_request_timeout_in_ms < LOWEST_ACCEPTED_TIMEOUT)
        {
           logInfo("aggregated_request_timeout_in_ms", conf.aggregated_request_timeout_in_ms, LOWEST_ACCEPTED_TIMEOUT);
           conf.aggregated_request_timeout_in_ms = LOWEST_ACCEPTED_TIMEOUT;
        }
    ...
    public static long getAggregatedQueryTimeout(TimeUnit unit)
    {
        return unit.convert(conf.aggregated_request_timeout_in_ms, MILLISECONDS);
    }
    ...
    public static long getMinRpcTimeout(TimeUnit unit)
    {
        return Longs.min(getRpcTimeout(unit),
                         ...
                         getAggregatedQueryTimeout(unit),
