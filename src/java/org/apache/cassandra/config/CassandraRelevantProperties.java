...
public enum CassandraRelevantProperties
{
    ...
    /**
     * Enable or disable table-level metrics collection. When disabled, TableMetrics will not be created
     * for ColumnFamilyStore instances, reducing memory overhead and metric collection costs.
     * Default: true (metrics enabled for backward compatibility)
     */
    TABLE_METRICS_ENABLED("cassandra.table_metrics.enabled", "true"),
    /**
     * Enable or disable keyspace-level metrics collection. When disabled, KeyspaceMetrics will not be created
     * for Keyspace instances, reducing memory overhead and metric collection costs.
     * Default: true (metrics enabled for backward compatibility)
     */
