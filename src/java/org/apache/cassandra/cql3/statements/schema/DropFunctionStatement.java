...
public final class DropFunctionStatement extends AlterSchemaStatement
{
    ...
    public static final class Raw extends AlterSchemaStatement.Raw<DropFunctionStatement>
    {
        ...
        @Override
        public DropFunctionStatement prepare(ClientState state, java.util.function.Function<String, String> keyspaceMapper)
        {
