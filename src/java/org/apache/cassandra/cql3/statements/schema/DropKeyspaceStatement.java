...
public final class DropKeyspaceStatement extends AlterSchemaStatement
{
    ...
    public static final class Raw extends AlterSchemaStatement.Raw<DropKeyspaceStatement>
    {
        ...
        @Override
        public DropKeyspaceStatement prepare(ClientState state, Function<String, String> keyspaceMapper)
        {
            return new DropKeyspaceStatement(keyspaceMapper.apply(keyspaceName), ifExists);
        }
    }
}
