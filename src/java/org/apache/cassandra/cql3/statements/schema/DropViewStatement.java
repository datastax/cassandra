...
public final class DropViewStatement extends AlterSchemaStatement
{
    ...
    public static final class Raw extends AlterSchemaStatement.Raw<DropViewStatement>
    {
        ...
        @Override
        public DropViewStatement prepare(ClientState state, Function<String, String> keyspaceMapper)
        {
