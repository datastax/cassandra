...
public final class DropTableStatement extends AlterSchemaStatement
{
    ...
    public static final class Raw extends AlterSchemaStatement.Raw<DropTableStatement>
    {
        ...
        @Override
        public DropTableStatement prepare(ClientState state, Function<String, String> keyspaceMapper)
        {
