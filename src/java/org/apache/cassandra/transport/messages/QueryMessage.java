...
public class QueryMessage extends Message.Request
{
    ...
    @Override
    protected Future<Response> maybeExecuteAsync(QueryState state, long queryStartNanoTime, boolean traceRequest)
    {
        ...
        try
        {
            ...
            if (asyncStage.isPresent())
            {
                ...
                return ImmediateFuture.success(handleRequest(state, queryHandler, queryStartNanoTime, statement, requestStartMillisTime));
        }
