...
public class ScanAllRangesCommandIterator extends RangeCommandIterator
{
    ...
    {
        super(replicaPlans, command, totalRangeCount, totalRangeCount, totalRangeCount, requestTime, readTracker);
    ...
    protected PartitionIterator sendNextRequests()
    {
        ...
        DataResolver<EndpointsForRange, ReplicaPlan.ForRangeRead> resolver = new DataResolver<>(command, sharedReplicaPlan, NoopReadRepair.instance, requestTime, false, readTracker);
