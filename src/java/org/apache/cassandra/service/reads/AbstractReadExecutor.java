...
public abstract class AbstractReadExecutor
{
                                                       ...
                                                       QueryInfoTracker.ReadTracker readTracker) throws UnavailableException
    {
        ...
        ReplicaPlan.ForTokenRead replicaPlan = ReplicaPlans.forRead(keyspace, command.partitionKey().getToken(), command.indexQueryPlan(), consistencyLevel, retry, command.rowFilter().allowFitlering);
