...
public interface StorageServiceMBean extends NotificationEmitter
{
    ...
    public int scrub(boolean disableSnapshot, boolean skipCorrupted, boolean checkData, org.apache.cassandra.db.compaction.Scrubber.OverwriteTTLMode overwriteTTLMode, int jobs, String keyspaceName, String... columnFamilies) throws IOException, ExecutionException, InterruptedException;
