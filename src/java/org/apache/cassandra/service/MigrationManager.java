...
public class MigrationManager
{
    ...
    // Since 3014 protocol contains only a CASSANDRA-13004 bugfix, it is safe to accept schema changes
    // from both 30 and 3014.
    private static boolean is30Compatible(int version)
    {
        return version == MessagingService.VERSION_30 || version == MessagingService.VERSION_3014;
    }
     ...
     * @param compatible flag whether {@code version} is a DSE 5.0 compatible version (DB-1477)
     */
    public static void passiveAnnounce(UUID version, boolean compatible)
    {
        ...
        logger.debug("Gossiping my {} schema version {}",
                     compatible ? "DSE 5.0 compatible" : "DSE 5.1",
