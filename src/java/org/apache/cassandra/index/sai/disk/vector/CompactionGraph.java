...
public class CompactionGraph implements Closeable, Accountable
{
     ...
     */
    public AsyncAdd maybeAddVector(ByteBuffer term, Integer key) throws IOException
    {
        ...
        if (postings == null)
        {
            ...
            if (postingsMap.putIfAbsent(vector, postings) == null)
            {
                ...
                return new AsyncAdd(bytesUsed, ordinal, vector);
            }
            else
            {
        ...
        return new AsyncAdd(bytesUsed);
    }

    public long addGraphNode(AsyncAdd asyncAdd)
    {
        return builder.addGraphNode(asyncAdd.ordinal, asyncAdd.vector);
    }
    ...
    public static class AsyncAdd
    {
        public final long bytesUsed;
        public final Integer ordinal;
        public final VectorFloat<?> vector;

        public AsyncAdd(long bytesUsed, Integer ordinal, VectorFloat<?> vector)
        {
        ...
        public AsyncAdd(long bytesUsed)
        {
