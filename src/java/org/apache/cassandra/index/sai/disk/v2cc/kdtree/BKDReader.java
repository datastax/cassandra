 ...
 */
package org.apache.cassandra.index.sai.disk.v2cc.kdtree;
...
public class BKDReader extends TraversingBKDReader implements Closeable
{
                        ...
                        LongArrayList tempPostings) throws IOException
    {
        ...
        leafInput.skipBytes(orderMapPointer + orderMapLength);
    ...
    private int readCompressedDim(DataInput in) throws IOException
    {
     ...
     */
    private void readCommonPrefixes(int[] commonPrefixLengths, byte[] scratchPackedValue, DataInput in) throws IOException
    {
        for (int dim = 0; dim < numDims; dim++)
        {
