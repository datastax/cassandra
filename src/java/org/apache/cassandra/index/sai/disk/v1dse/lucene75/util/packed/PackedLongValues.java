...
import org.apache.cassandra.index.sai.disk.v1dse.lucene75.util.LongValues;
import org.apache.cassandra.index.sai.disk.v1dse.lucene75.util.RamUsageEstimator;

import static org.apache.cassandra.index.sai.disk.v1dse.lucene75.util.packed.PackedInts.checkBlockSize;
  ...
  public static class Builder implements Accountable {
    ...
    void pack(long[] values, int numValues, int block, float acceptableOverheadRatio) {
      ...
      if (minValue == 0 && maxValue == 0) {
        ...
        final int bitsRequired = minValue < 0 ? 64 : org.apache.lucene.util.packed.PackedInts.bitsRequired(maxValue);
