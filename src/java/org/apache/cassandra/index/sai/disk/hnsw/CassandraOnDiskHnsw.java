...
public class CassandraOnDiskHnsw implements AutoCloseable
{
    ...
    public CassandraOnDiskHnsw(SegmentMetadata.ComponentMetadataMap componentMetadatas, PerIndexFiles indexFiles, IndexContext context) throws IOException
    {
        ...
        QueryContext mockContext = new QueryContext();
        try (OnDiskVectors vectors = new OnDiskVectors(indexFiles.vectors(), vectorsSegmentOffset))
        {
                                        ...
                                        RowIdScoreRecorder sstableRowIdScoreRecorder)
    {
        ...
        NeighborQueue queue;
        try (VectorsWithCache vectors = vectorsSupplier.apply(context); OnDiskHnswGraph.OnDiskView view = hnsw.getView(context))
        {
                                                      ...
                                                      RowIdScoreRecorder sstableRowIdScoreRecorder) throws IOException
    {
        ...
        try (RowIdIterator iterator = new RowIdIterator(queue, sstableRowIdScoreRecorder))
        {
    ...
    class VectorsWithCache implements RandomAccessVectorValues<float[]>, AutoCloseable
    {
        ...
        public float[] vectorValue(int i) throws IOException
        {
            ...
            float[] cached = vectorCache.get(i);
            if (cached != null)
            {
