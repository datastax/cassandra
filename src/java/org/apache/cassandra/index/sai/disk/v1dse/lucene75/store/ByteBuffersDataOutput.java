 ...
 */
package org.apache.cassandra.index.sai.disk.v1dse.lucene75.store;
...
import org.apache.cassandra.index.sai.disk.v1dse.lucene75.util.BitUtil;
...
import org.apache.cassandra.index.sai.disk.v1dse.lucene75.util.UnicodeUtil;

/**
 * A {@link org.apache.lucene.store.DataOutput} storing data in a list of {@link ByteBuffer}s.
 */
public final class ByteBuffersDataOutput extends DataOutput implements Accountable
{
  ...
  /**
   * Copy the current content of this object into another {@link org.apache.lucene.store.DataOutput}.
   */
