...
public class SegmentMetadata implements Comparable<SegmentMetadata>
{
    ...
    /**
     * Whether this segment is the last one in the sstable.
     */
    public final boolean isLastSegmentInSSTable;
    ...
    SegmentMetadata(long segmentRowIdOffset,
                    ...
                    long totalTermCount,
                    Version version,
                    boolean isLastSegmentInSSTable)
    {
    ...
    private SegmentMetadata(IndexInput input, IndexContext context, Version version, SSTableContext sstableContext, boolean loadFullResolutionBounds, boolean isLastSegment) throws IOException
    {
        ...
        this.version = version;
        this.isLastSegmentInSSTable = isLastSegment;
    ...
    private static List<SegmentMetadata> load(MetadataSource source, IndexContext context, SSTableContext sstableContext, boolean loadFullResolutionBounds) throws IOException
    {
        ...
        for (int i = 0; i < segmentCount; i++)
        {
            ...
            segmentMetadata.add(new SegmentMetadata(input, context, source.getVersion(), sstableContext, loadFullResolutionBounds, isLastSegment));
        }
