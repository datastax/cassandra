...
public class IndexDescriptor
{
    ...
    {
        IndexComponentDiscovery.DiscoveredGroups discovered = IndexComponentDiscovery.instance.discoverComponents(sstable.descriptor);
    ...
    private void populateOne(@Nullable IndexComponentDiscovery.DiscoveredComponents discovered, @Nullable IndexContext context)
    {
        ...
        {
            components = new IndexComponentsImpl(context, discovered.buildId());
    ...
    {
        IndexComponentDiscovery.DiscoveredGroups discovered = IndexComponentDiscovery.instance.discoverComponents(descriptor);
