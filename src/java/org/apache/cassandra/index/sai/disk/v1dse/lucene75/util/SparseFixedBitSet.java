 ...
 */
package org.apache.cassandra.index.sai.disk.v1dse.lucene75.util;


import java.io.IOException;

import org.apache.cassandra.index.sai.disk.v1dse.lucene75.search.DocIdSetIterator;
...
public class SparseFixedBitSet extends BitSet implements Bits, Accountable
{
  ...
  private static final long BASE_RAM_BYTES_USED = org.apache.lucene.util.RamUsageEstimator.shallowSizeOfInstance(SparseFixedBitSet.class);
  private static final long SINGLE_ELEMENT_ARRAY_BYTES_USED = org.apache.lucene.util.RamUsageEstimator.sizeOf(new long[1]);
  ...
  public SparseFixedBitSet(int length) {
    ...
    ramBytesUsed = BASE_RAM_BYTES_USED
                   + org.apache.lucene.util.RamUsageEstimator.shallowSizeOf(indices)
                   + org.apache.lucene.util.RamUsageEstimator.shallowSizeOf(bits);
  }
  ...
  private void insertLong(int i4096, int i64, int i, long index) {
    ...
    if (bitArray[bitArray.length - 1] == 0) {
      ...
      ramBytesUsed += org.apache.lucene.util.RamUsageEstimator.sizeOf(newBitArray) - RamUsageEstimator.sizeOf(bitArray);
    }
    ++nonZeroLongCount;
  }
