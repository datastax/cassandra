 ...
 */
package org.apache.cassandra.index.sai.disk.v1dse.trie;
...
import org.apache.cassandra.index.sai.disk.v1dse.io.IndexOutputWriter;
...
public class TrieTermsDictionaryWriter implements Closeable
{
    ...
    {
        termDictionaryOutput = IndexFileUtils.instance.openPerIndexOutput(IndexComponent.TERMS_DATA, indexDescriptor, indexContext, true);
