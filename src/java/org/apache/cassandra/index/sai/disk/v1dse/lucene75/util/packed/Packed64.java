...
class Packed64 extends PackedInts.MutableImpl {
  ...
  public Packed64(int valueCount, int bitsPerValue) {
    ...
    final org.apache.lucene.util.packed.PackedInts.Format format = org.apache.lucene.util.packed.PackedInts.Format.PACKED;
    final int longCount = format.longCount(org.apache.lucene.util.packed.PackedInts.VERSION_CURRENT, valueCount, bitsPerValue);
  ...
  public Packed64(int packedIntsVersion, DataInput in, int valueCount, int bitsPerValue)
    ...
    final int longCount = format.longCount(org.apache.lucene.util.packed.PackedInts.VERSION_CURRENT, valueCount, bitsPerValue); // to size the array
