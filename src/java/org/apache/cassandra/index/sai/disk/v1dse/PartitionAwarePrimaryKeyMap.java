...
import org.apache.cassandra.index.sai.disk.v1dse.bitpack.BlockPackedReader;
import org.apache.cassandra.index.sai.disk.v1dse.bitpack.MonotonicBlockPackedReader;
import org.apache.cassandra.index.sai.disk.v1dse.bitpack.NumericValuesMeta;
    ...
    public static class PartitionAwarePrimaryKeyMapFactory implements Factory
    {
        ...
        public PartitionAwarePrimaryKeyMapFactory(IndexDescriptor indexDescriptor, SSTableReader sstable)
        {
            try
            {
                ...
                token = indexDescriptor.createPerSSTableFileHandle(IndexComponent.TOKEN_VALUES, null);
                offset = indexDescriptor.createPerSSTableFileHandle(IndexComponent.OFFSETS_VALUES, null);
