...
public class CryptoUtils
{
    ...
    public static DataInput uncompress(IndexInput input, ICompressor compressor) throws IOException
    {
     ...
     */
    public static DataInput uncompress(IndexInput input, ICompressor compressor, BytesRef compBytes, BytesRef uncompBytes) throws IOException
    {
        ...
        return new ByteArrayDataInput(uncompBytes.bytes, 0, uncompBytesLen);
    }
