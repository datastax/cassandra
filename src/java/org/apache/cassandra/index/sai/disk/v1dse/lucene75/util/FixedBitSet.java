 ...
 * {@code DocIdSet}. If you need to manage more than 2.1B bits, use
 * {@link LongBitSet}.
 * 
 * @lucene.internal
 */
public final class FixedBitSet extends BitSet implements Bits, Accountable
{
  ...
  private static final long BASE_RAM_BYTES_USED = org.apache.lucene.util.RamUsageEstimator.shallowSizeOfInstance(FixedBitSet.class);
