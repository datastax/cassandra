...
public class Version
{
    ...
    public static final Version FA = new Version("fa", V7OnDiskFormat.instance, (c, i, g) -> stargazerFileNameFormat(c, i, g, "fa"));
    ...
    public static final List<Version> ALL = Lists.newArrayList(FA, EB, DC, DB, CA, BA, AA);
    ...
    private static volatile Version LATEST = parse(System.getProperty("cassandra.sai.latest.version", FA.version));
