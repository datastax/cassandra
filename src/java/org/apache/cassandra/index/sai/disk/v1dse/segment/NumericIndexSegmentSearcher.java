...
import org.apache.cassandra.index.sai.disk.v1dse.PerColumnIndexFiles;
import org.apache.cassandra.index.sai.disk.v1dse.kdtree.BKDReader;
...
import static org.apache.cassandra.index.sai.disk.v1dse.kdtree.BKDQueries.bkdQueryFrom;
...
public class NumericIndexSegmentSearcher extends IndexSegmentSearcher
{
    ...
    public String toString()
    {
        return MoreObjects.toStringHelper(this)
                          ...
                          .add("bytesPerValue", bkdReader.getBytesPerDimension())
                          .toString();
    }
