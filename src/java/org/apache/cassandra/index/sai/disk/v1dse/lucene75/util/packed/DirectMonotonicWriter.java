 ...
 * {@link org.apache.lucene.util.packed.DirectWriter}.
 * 
...
public final class DirectMonotonicWriter {
  ...
  private void flush() throws IOException {
    ...
    if (maxDelta == 0) {
      ...
      final int bitsRequired = org.apache.lucene.util.packed.DirectWriter.unsignedBitsRequired(maxDelta);
      org.apache.lucene.util.packed.DirectWriter writer = DirectWriter.getInstance(data, bufferSize, bitsRequired);
      for (int i = 0; i < bufferSize; ++i) {
        writer.add(buffer[i]);
      }
      writer.finish();
