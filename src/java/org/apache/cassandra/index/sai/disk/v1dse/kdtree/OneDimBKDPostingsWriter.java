...
import org.apache.cassandra.index.sai.disk.v1dse.postings.PackedLongsPostingList;
import org.apache.cassandra.index.sai.disk.v1dse.postings.PostingsWriter;
...
public class OneDimBKDPostingsWriter implements TraversingBKDReader.IndexTreeTraversalCallback
{
    ...
    public long finish(IndexOutput out) throws IOException
    {
        ...
        for (int nodeID : Iterables.concat(internalNodeIDs, leafNodeIDs))
        {
            ...
            final PriorityQueue<PeekablePostingList> postingLists = new PriorityQueue<>(100, Comparator.comparingLong(PeekablePostingList::peek));
