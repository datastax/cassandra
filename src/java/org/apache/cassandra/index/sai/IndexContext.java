...
public class IndexContext
{
    ...
    public static final String MULTIPLE_HINTS_WITH_ORDER_BY_ERRROR_MESSAGE =
    "Index hints including an index used for ORDER BY cannot include any other index";
    ...
    public void validate(RowFilter rowFilter)
    {
        ...
        for (RowFilter.Expression expression : rowFilter.root.expressions())
        {
            ...
            {
                throw new InvalidRequestException(MULTIPLE_HINTS_WITH_ORDER_BY_ERRROR_MESSAGE);
            }
