...
public class StorageAttachedIndex implements Index
{
    ...
    public static Map<String, String> validateOptions(Map<String, String> options, TableMetadata metadata)
    {
        ...
        {
            if (!Version.current().onOrAfter(Version.JVECTOR_EARLIEST))
            {
                throw new InvalidRequestException(vectorUnsupportedByVersionError(Version.current()));
            }
    ...
    private Future<?> startInitialBuild(ColumnFamilyStore baseCfs, boolean validate, boolean skipIndexBuild)
    {
        ...
        {
            throw new FeatureNeedsIndexRebuildException(vectorUnsupportedByVersionError(Version.current()));
        }
