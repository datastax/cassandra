...
public class QueryViewBuilder
{
    ...
    protected QueryView build()
    {
        ...
        finally
        {
            ...
            {
                List<String> indexNames = referencedIndexes.stream().map(i -> i.getIndexContext().getIndexName()).collect(Collectors.toList());
    ...
    private Map<SSTableReader, List<IndexExpression>> getQueryView(Collection<Expression> expressions)
    {
        ...
        for (Expression expression : expressions)
        {
            ...
            for (SSTableIndex index: view.match(expression))
            {
