 ...
 */
public class TermIterator extends KeyRangeIterator
{
    ...
    private TermIterator(KeyRangeIterator union, Set<SSTableIndex> referencedIndexes, QueryContext queryContext)
    {
