...
public class TableQueryMetrics
{
    ...
    public TableQueryMetrics(TableMetadata table)
    {
        ...
        addMetrics(table, "Filter", cmd -> !cmd.isTopK());
        addMetrics(table, "TopK", ReadCommand::isTopK);
        addMetrics(table, "SinglePartition", ReadCommand::isSinglePartition);
        addMetrics(table, "Range", cmd -> !cmd.isSinglePartition());
    }
    ...
    /**
     * Per table metrics for a specific type of query.
     */
    ...
    /**
     * Per query metrics for a specific type of query.
     */
