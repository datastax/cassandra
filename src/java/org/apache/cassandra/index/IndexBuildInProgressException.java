 ...
 */
public final class IndexBuildInProgressException extends RuntimeException implements InternalRequestExecutionException
{
    /**
    ...
    {
        return RequestFailureReason.INDEX_BUILD_IN_PROGRESS;
    }
}
