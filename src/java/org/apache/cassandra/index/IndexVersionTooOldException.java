 ...
 */
public final class IndexVersionTooOldException extends UncheckedInternalRequestExecutionException
{
    /**
     * Creates a new {@code IndexVersionTooOldException} for the specified message.
     *
     * @param message the explanation of the error
     */
    public IndexVersionTooOldException(String message)
    {
        super(RequestFailureReason.INDEX_VERSION_TOO_OLD, message);
    }
}
