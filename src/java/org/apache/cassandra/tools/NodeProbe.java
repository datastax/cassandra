...
public class NodeProbe implements AutoCloseable
{
    ...
    {
        int concurrentCompactors = getConcurrentCompactors();
        if (jobs > concurrentCompactors)
            out.printf("jobs (%d) is bigger than configured concurrent_compactors (%d), using at most %d threads%n", jobs, concurrentCompactors, concurrentCompactors);
    }
