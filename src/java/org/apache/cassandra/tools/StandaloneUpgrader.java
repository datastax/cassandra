...
public class StandaloneUpgrader
{
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            if (SchemaManager.instance.getTableMetadataRef(options.keyspace, options.cf) == null)
            ...
            {
                try (LifecycleTransaction txn = LifecycleTransaction.offline(OperationType.UPGRADE_SSTABLES, cfs.metadata, sstable))
                {
