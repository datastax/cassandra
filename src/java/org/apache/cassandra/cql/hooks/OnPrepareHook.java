...
import org.apache.cassandra.cql.CQLExecutionContext;
 ...
 */
public interface OnPrepareHook
{
    /**
     ...
     */
    public void execute(CQLStatement statement, CQLExecutionContext context) throws InvalidRequestException;

    public static final OnPrepareHook NO_OP = new OnPrepareHook()
    {
        @Override
