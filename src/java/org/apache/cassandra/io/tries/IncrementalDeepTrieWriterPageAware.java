...
class IncrementalDeepTrieWriterPageAware<VALUE> extends IncrementalTrieWriterPageAware<VALUE>
{
    ...
    IncrementalDeepTrieWriterPageAware(TrieSerializer<VALUE, ? super DataOutputPlus> trieSerializer, DataOutputPlus dest, int maxRecursionDepth, ByteComparable.Version encodingVersion)
    {
        super(trieSerializer, dest, encodingVersion);
        this.maxRecursionDepth = maxRecursionDepth;
    }

    IncrementalDeepTrieWriterPageAware(TrieSerializer<VALUE, ? super DataOutputPlus> trieSerializer, DataOutputPlus dest, ByteComparable.Version encodingVersion)
    {
        this(trieSerializer, dest, 64, encodingVersion);
    }
