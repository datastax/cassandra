...
public interface IncrementalTrieWriter<VALUE> extends AutoCloseable
{
     ...
     */
    static <VALUE> IncrementalTrieWriter<VALUE> open(TrieSerializer<VALUE, ? super DataOutputPlus> trieSerializer, DataOutputPlus dest, ByteComparable.Version encodingVersion)
    {
        return new IncrementalDeepTrieWriterPageAware<>(trieSerializer, dest, encodingVersion);
    }
}