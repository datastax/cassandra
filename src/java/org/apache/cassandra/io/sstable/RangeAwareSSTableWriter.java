...
public class RangeAwareSSTableWriter implements SSTableMultiWriter
{
    ...
    public RangeAwareSSTableWriter(ColumnFamilyStore cfs, long estimatedKeys, long repairedAt, TimeUUID pendingRepair, boolean isTransient, SSTableFormat<?, ?> format, IntervalSet<CommitLogPosition> commitLogIntervals, int sstableLevel, long totalSize, LifecycleNewTracker lifecycleNewTracker, SerializationHeader header) throws IOException
    {
