    ...
    protected SSTableReader openFinal(SSTableReader.OpenReason reason, StorageHandler storageHandler)
    {
        ...
        catch (Throwable t)
        {
            if (storageHandler != null)
                return storageHandler.onOpeningWrittenSSTableFailure(reason, descriptor, components(), dfile.onDiskLength, dfile.dataLength(), stats, firstMinimized, lastMinimized, t);
