...
public class PurgeCursor implements SSTableCursor, DeletionPurger
{
    ...
    public PurgeCursor(SSTableCursor wrapped, CompactionController controller, long nowInSec)
    {
    ...
    private LivenessInfo maybePurge(LivenessInfo liveness, long nowInSec)
    {
