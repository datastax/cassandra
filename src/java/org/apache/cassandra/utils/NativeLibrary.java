...
{
    static final Logger logger = LoggerFactory.getLogger(NativeLibrary.class);

    String CUSTOM_NATIVE_LIBRARY = "cassandra.custom_native_library";
    NativeLibrary instance = System.getProperty(CUSTOM_NATIVE_LIBRARY) == null
                             ? new NativeLibraryImpl()
     ...
     */
    boolean isOS(NativeLibrary.OSType type);
