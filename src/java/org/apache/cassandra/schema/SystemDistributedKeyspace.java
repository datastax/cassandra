...
public final class SystemDistributedKeyspace
{
     ...
     */
    public static final long GENERATION = CassandraRelevantProperties.AUTOREPAIR_ENABLE.getBoolean() ? 7 : 6;
    ...
    private static final Set<String> TABLE_NAMES = ImmutableSet.of(REPAIR_HISTORY, PARENT_REPAIR_HISTORY,
                                                                    VIEW_BUILD_STATUS, PARTITION_DENYLIST_TABLE);
    private static final Set<String> TABLE_NAMES_WITH_AUTO_REPAIR = ImmutableSet.of(REPAIR_HISTORY, PARENT_REPAIR_HISTORY,
                                                                                     VIEW_BUILD_STATUS, PARTITION_DENYLIST_TABLE,
    ...
    {
        return CassandraRelevantProperties.AUTOREPAIR_ENABLE.getBoolean()
               ? TABLE_NAMES_WITH_AUTO_REPAIR
               : TABLE_NAMES;
    }
    ...
    public static KeyspaceMetadata metadata()
    {
        ...
        if (CassandraRelevantProperties.AUTOREPAIR_ENABLE.getBoolean())
        {
            tables = Tables.of(RepairHistory, ParentRepairHistory, ViewBuildStatus,
                               PartitionDenylistTable, AutoRepairHistory, AutoRepairPriority);
        }
        else
        {
            tables = Tables.of(RepairHistory, ParentRepairHistory, ViewBuildStatus,
