 ...
 *   <li> a singleton {@link SensorEncoder} implementation that encodes the sensor name as {@literal "<SENSOR_TYPE>_REQUEST.<TABLE_NAME>"} for request sensors and {@literal "<SENSOR_TYPE>_GLOBAL.<TABLE_NAME>"} for global sensors.</li>
 * </ul>
 */
