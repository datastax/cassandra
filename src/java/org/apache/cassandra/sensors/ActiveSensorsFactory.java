 ...
 * <ul>
 *   <li>a new {@link ActiveRequestSensors} instance restricted to the provided keyspaces (plus system keyspaces).</li>
...
public class ActiveSensorsFactory implements SensorsFactory
{
    ...
    @Override
    public RequestSensors createRequestSensors(Set<String> keyspaces)
    {
        return new ActiveRequestSensors(keyspaces.isEmpty() ? null : keyspaces);
    }
