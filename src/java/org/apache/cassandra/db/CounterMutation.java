...
import static org.apache.cassandra.config.CassandraRelevantProperties.COUNTER_LOCKS_PER_THREAD;
...
public class CounterMutation implements IMutation
{
    ...
    private static final Striped<Lock> LOCKS = Striped.lazyWeakLock(DatabaseDescriptor.getConcurrentCounterWriters() * COUNTER_LOCKS_PER_THREAD.getInt());
