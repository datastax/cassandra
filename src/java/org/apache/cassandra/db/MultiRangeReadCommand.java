...
public class MultiRangeReadCommand extends ReadCommand
{
    ...
    {
        super(Kind.MULTI_RANGE, isDigest, digestVersion, acceptsTransient, metadata, nowInSec, columnFilter, rowFilter, limits, indexQueryPlan, trackWarnings, null);
    ...
    @Override
    public PartitionIterator execute(ConsistencyLevel consistency, ClientState clientState, final Dispatcher.RequestTime requestTime) throws RequestExecutionException
    {
