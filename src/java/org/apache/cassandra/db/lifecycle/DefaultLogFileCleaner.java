...
final class DefaultLogFileCleaner implements LogFileCleaner
{
    private static final Logger logger = LoggerFactory.getLogger(DefaultLogFileCleaner.class);
    ...
    public boolean removeUnfinishedLeftovers()
    {
        return files.entrySet()
                    .stream()
                    .map(DefaultLogFileCleaner::removeUnfinishedLeftovers)
