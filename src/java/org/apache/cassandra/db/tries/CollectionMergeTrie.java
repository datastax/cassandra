...
/// are advanced (see [CollectionMergeCursor]).
///
...
class CollectionMergeTrie<T> implements Trie<T>
{
    ...
    static class CollectionMergeCursor<T> implements Cursor<T>
    {
        ...
        private <I> CollectionMergeCursor(CollectionMergeResolver<T> resolver, Direction direction, Collection<I> inputs, BiFunction<I, Direction, Cursor<T>> extractor)
        {
            this.resolver = resolver;
        ...
        {
            this(resolver, direction, inputs, Trie::cursor);
        }
