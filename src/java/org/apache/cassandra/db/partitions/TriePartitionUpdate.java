...
public class TriePartitionUpdate extends TrieBackedPartition implements PartitionUpdate
{
    ...
    /// does not have to lay it out again. Sizing the trie means writing it -- the on-disk writer only knows the total
    /// once it has emitted the root -- and [org.apache.cassandra.db.Mutation] sizes a mutation and then immediately
