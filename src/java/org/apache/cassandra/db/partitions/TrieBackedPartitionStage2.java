 ...
 */
public class TrieBackedPartitionStage2 implements Partition
{
    /**
    ...
    public static class RowData implements IDataSize
    {
        ...
        final long minLocalDeletionTime;
        ...
        RowData(Object[] columnsBTree, LivenessInfo livenessInfo, DeletionTime deletion, long minLocalDeletionTime)
        {
    ...
    public TrieBackedPartitionStage2(DecoratedKey partitionKey,
    ...
    public static TrieBackedPartitionStage2 fromIterator(UnfilteredRowIterator iterator)
    {
        ContentBuilder builder = build(iterator, false);
        return new TrieBackedPartitionStage2(iterator.partitionKey(),
                                             iterator.columns(),
                                             iterator.stats(),
     ...
     */
    public static TrieBackedPartitionStage2 create(DecoratedKey partitionKey,
                                                   ...
                                                   EnsureOnHeap ensureOnHeap)
    {
        return ensureOnHeap == EnsureOnHeap.NOOP
               ? new TrieBackedPartitionStage2(partitionKey, columnMetadata, encodingStats, rowCountIncludingStatic, trie, metadata, true)
    ...
    {
        BTreeRow brow = BTreeRow.asBTreeRow(row);
    ...
    class SlicesIterator extends AbstractUnfilteredRowIterator
    {
        ...
        private SlicesIterator(ColumnFilter selection,
                               ...
                               Row staticRow)
        {
            super(TrieBackedPartitionStage2.this.metadata(), TrieBackedPartitionStage2.this.partitionKey(),
                  TrieBackedPartitionStage2.this.partitionLevelDeletion(),
                  selection.fetchedColumns(), staticRow, isReversed, TrieBackedPartitionStage2.this.stats());
     ...
     */
    private static final class WithEnsureOnHeap extends TrieBackedPartitionStage2
    {
