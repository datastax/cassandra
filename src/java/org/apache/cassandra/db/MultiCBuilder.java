...
public class MultiCBuilder
{
    ...
    public static class Element
    {
        ...
        public static final Element BOTTOM = new Element(Collections.emptyList(), Kind.INCL_START);
        public static final Element TOP = new Element(Collections.emptyList(), Kind.INCL_END);
        public static final Element ROOT = new Element(Collections.emptyList(), Kind.POINT);
    ...
    public List<ByteBuffer> buildSerializedPartitionKeys()
    {
        ...
        if (elements.get(0) == Element.ROOT)
        ...
        for (Element element: elements)
            set.add(element.value.size() == 1 ? element.value.get(0) : toComposite(element.value));
