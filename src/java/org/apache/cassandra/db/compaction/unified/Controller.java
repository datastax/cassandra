...
import static org.apache.cassandra.config.CassandraRelevantProperties.UCS_TARGET_SSTABLE_SIZE;
...
//
    ...
    public static final double DEFAULT_TARGET_SSTABLE_SIZE = FBUtilities.parseHumanReadable(UCS_TARGET_SSTABLE_SIZE.getString(), null, "B");
    ...
    static final OverlapInclusionMethod DEFAULT_OVERLAP_INCLUSION_METHOD =
        OverlapInclusionMethod.valueOf(UCS_OVERLAP_INCLUSION_METHOD.getString(OverlapInclusionMethod.TRANSITIVE.toString()).toUpperCase());
