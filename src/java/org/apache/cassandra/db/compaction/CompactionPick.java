...
public class CompactionPick
{
    ...
    private CompactionPick(TimeUUID id,
                           long parent,
     ...
     */
    public static CompactionPick create(TimeUUID id,
                                        long parent,
    ...
    static CompactionPick createWithUnknownParent(TimeUUID id, Collection<? extends CompactionSSTable> sstables)
    {
     ...
     */
    static CompactionPick create(TimeUUID id,
                                 long parent,
                                 Collection<? extends CompactionSSTable> sstables,
                                 Collection<? extends CompactionSSTable> expired,
                                 double hotness,
    ...
    public void setSubmitted(TimeUUID id)
    {
