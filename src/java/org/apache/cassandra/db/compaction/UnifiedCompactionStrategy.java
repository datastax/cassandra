...
public class UnifiedCompactionStrategy extends AbstractCompactionStrategy
{
     ...
     */
    private CompactionTask createCompactionTask(LifecycleTransaction transaction, long gcBefore)
    {
        if (controller.getNumShards() <= 1)
    ...
    final static class Shard implements Comparable<Shard>
    {
         ...
         */
        Set<SSTableReader> getExpiredSSTables(long gcBefore, boolean ignoreOverlaps)
        {
