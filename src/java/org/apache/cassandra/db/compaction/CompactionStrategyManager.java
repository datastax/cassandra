...
public class CompactionStrategyManager implements CompactionStrategyContainer
{
    ...
    private void validateForCompaction(Iterable<? extends CompactionSSTable> input)
    {
        ...
        try
        {
            ...
            TimeUUID pendingRepair = firstSSTable.getPendingRepair();
     ...
     */
    @Override
    public CompactionTasks getUserDefinedTasks(Collection<? extends CompactionSSTable> sstables, long gcBefore)
    {
        maybeReloadDiskBoundaries();
