...
public class SinglePartitionReadCommand extends ReadCommand implements SinglePartitionReadQuery
{
    ...
    public PartitionIterator execute(ConsistencyLevel consistency, ClientState state, Dispatcher.RequestTime requestTime) throws RequestExecutionException
    {
        ...
        return StorageProxy.read(Group.one(this), consistency, state, requestTime);
    }
    ...
    public UnfilteredRowIterator queryMemtableAndDisk(ColumnFamilyStore cfs, ReadExecutionController executionController)
    {
        ...
        return queryMemtableAndDiskInternal(cfs, executionController, Clock.Global.nanoTime());
    }
                                                                           ...
                                                                           long startTimeNanos)
    {
        ...
        UnfilteredRowIterator iterator = result.unfilteredIterator(columnFilter(), Slices.ALL, clusteringIndexFilter().isReversed());
