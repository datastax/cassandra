...
import org.apache.cassandra.index.sai.disk.v2.WidePrimaryKeyMap;
...
public class KeyLookupBench
{
    ...
    public void trialSetup() throws Exception
    {
        ...
        PerSSTableWriter writer = Version.current().onDiskFormat().newPerSSTableWriter(indexDescriptor);
//        new SSTableComponentsWriter(indexDescriptor);
