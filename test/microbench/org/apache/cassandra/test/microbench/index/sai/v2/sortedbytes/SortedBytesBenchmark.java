...
public class SortedBytesBenchmark extends AbstractOnDiskBenchmark
{
    ...
    public void beforeInvocation() throws Throwable
    {
        ...
        trieFile = indexComponents.createFileHandle(indexComponents.kdTree);
        bytesInput = indexComponents.openBlockingInput(indexComponents.termsData);
        blockFPInput = indexComponents.openBlockingInput(indexComponents.kdTreePostingLists);
