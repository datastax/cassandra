...
public class V5VectorPostingsWriterBench
{
    ...
    {
        V5VectorPostingsWriter.describeForCompaction(V5VectorPostingsWriter.Structure.ONE_TO_MANY, numVectors, maxRowId.get(), numVectors - 1, postingsMap, Version.Selector.DEFAULT_VERSION);
    }

    @Benchmark
    public void describeForCompactionZeroOrOneToMany()
    {
        V5VectorPostingsWriter.describeForCompaction(V5VectorPostingsWriter.Structure.ZERO_OR_ONE_TO_MANY, numVectors, maxRowId.get(), numVectors - 1, postingsMap, Version.Selector.DEFAULT_VERSION);
    }
