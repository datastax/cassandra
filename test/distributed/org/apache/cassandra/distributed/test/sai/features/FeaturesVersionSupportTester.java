...
public abstract class FeaturesVersionSupportTester extends TestBaseImpl
{
    ...
    public void testANN()
    {
        ...
        if (version.onOrAfter(Version.CA))
        {
        ...
        else
        {
            ...
            cluster.setUncaughtExceptionsFilter((i, t) -> i == 2 &&
                                                          t.getClass().getName().contains(IndexVersionTooOldException.class.getName()) &&
     ...
     * Older versions should reject BM25 queries with {@link RequestFailureReason#INDEX_VERSION_TOO_OLD} errors.
     */
    @Test
    public void testBM25()
    {
        ...
        if (version.onOrAfter(Version.EC))
        {
        ...
        else
        {
            Assertions.assertThatThrownBy(() -> coordinator.execute(query, ONE))
                      .hasMessageContaining(RequestFailureReason.INDEX_VERSION_TOO_OLD.name());
        }
    }
