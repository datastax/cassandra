...
/**
 * {@link AllowFilteringDuringIndexBuildTester} for clusters with all nodes on mesaging version DS10.
 */
public class AllowFilteringDuringIndexBuildAllDS10Test extends AllowFilteringDuringIndexBuildTester
{
    @BeforeClass
    ...
    @Test
    public void testAllowFilteringDuringInitialIndexBuildWithAllDS10()
    {
        testSelectWithAllowFilteringDuringIndexBuilding(INDEX_NOT_AVAILABLE_MESSAGE, true, false);
    }

    @Test
    public void testAllowFilteringDuringIndexRebuildWithAllDS10NewTable()
    {
        testSelectWithAllowFilteringDuringIndexBuilding(INDEX_NOT_AVAILABLE_MESSAGE, false, true);
    }

    @Test
    public void testAllowFilteringDuringIndexRebuildWithAllDS10ExistingTable()
    {
