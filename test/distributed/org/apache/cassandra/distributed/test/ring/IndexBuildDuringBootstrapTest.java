...
public class IndexBuildDuringBootstrapTest extends IndexTestBase
{
    ...
    public void indexBuildDuringBootstrapTestV1() throws Throwable
    {
        ...
        try (Cluster cluster = builder().withNodes(originalNodeCount)
                                        ...
                                        .withInstanceInitializer(ByteBuddyUtils.IndexBuildBlocker::blockIndexBuilding)
    ...
    @Test
    public void indexBuildDuringBootstrapTestV2() throws Exception
    {
        int originalNodeCount = 2;
        int expandedNodeCount = originalNodeCount + 1;
