...
public class SensorsTest extends TestBaseImpl
{
    ...
    public static Collection<Object[]> data()
    {
        ...
        result.add(new Object[]{ tableSchema, noPrep, cas, new String[]{ EXPECTED_WRITE_BYTES_HEADER } });
    ...
    private static ResultMessage<?> executeWithResult(String query)
    {
        ...
        QueryOptions initialOptions = QueryOptions.create(cl,
                                                          ...
                                                          prepared.keyspace);
        return prepared.statement.execute(QueryProcessor.internalQueryState(), initialOptions, Dispatcher.RequestTime.forImmediateExecution());
    }
}