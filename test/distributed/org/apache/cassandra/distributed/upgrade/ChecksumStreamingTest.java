...
public class ChecksumStreamingTest extends TestBaseImpl
{
    ...
    private static Path digestPath(SSTableReader sstable, String checksumType)
    {
        switch (checksumType)
        {
            case "CRC32":    return sstable.descriptor.pathFor(Component.DIGEST);
            case "CRC32C":   return sstable.descriptor.pathFor(Component.DIGEST_CRC32C);
            case "CRC64NVME": return sstable.descriptor.pathFor(Component.DIGEST_CRC64NVME);
