    ...
    private static void testCSV(String option)
    {
        assertThatToolSucceds(option, "--min-size", "35", SSTABLE_1, SSTABLE_2)
                .isEqualTo(format("key,keyBinary,live,offset,size,rowCount,cellCount,tombstoneCount," +
                                  ...
                                  "\"0\",30,true,15,67185,50,50,0,0,0,0,0,0,0,%s,,,,,,1,big,ma\n" +
                                  "\"1\",31,true,67215,67190,50,50,0,0,0,0,0,0,0,%<s,,,,,,1,big,ma\n" +
                                  "\"2\",32,true,134420,67190,50,50,0,0,0,0,0,0,0,%<s,,,,,,1,big,ma\n" +
                                  "\"3\",33,true,201625,67190,50,50,0,0,0,0,0,0,0,%<s,,,,,,1,big,ma\n" +
                                  "\"4\",34,true,268830,67190,50,50,0,0,0,0,0,0,0,%<s,,,,,,1,big,ma\n",// +
