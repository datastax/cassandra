...
public class ReplicaPlansTest
{
    ...
    public void testFilterByAffinity() throws UnknownHostException
    {
        ...
        ReplicaPlan.ForTokenWrite writePlan1 =  ReplicaPlans.forWrite(keyspace1, ANY, natural, pending, Predicates.alwaysTrue(), ReplicaPlans.writeNormal);
        assertTrue(writePlan1.live().isEmpty());

        ReplicaPlan.ForTokenWrite writePlan2 =  ReplicaPlans.forWrite(keyspace2, ANY, natural, pending, Predicates.alwaysTrue(), ReplicaPlans.writeNormal);
