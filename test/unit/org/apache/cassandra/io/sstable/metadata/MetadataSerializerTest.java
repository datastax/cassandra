...
public class MetadataSerializerTest
{
    ...
    public static void initDD()
    {
        ...
        // Initialize compression params after DatabaseDescriptor is initialized
    ...
    public void testEncryption() throws IOException
    {
        ...
        MetadataSerializer serializer = new MetadataSerializer();
        Descriptor descriptor = new Descriptor(version, FileUtils.getTempDir(), "test", "test", new SequenceBasedSSTableId(0));
        File statsFile = serializeWithEncryption(originalMetadata, serializer, descriptor);
        ...
        // When encryption is enabled, the sensitive key should NOT be found in the file
    ...
    public File serialize(Map<MetadataType, MetadataComponent> metadata, MetadataSerializer serializer, Descriptor descriptor)
    throws IOException
    {
    ...
    public void testOldReadsNew(String oldV, String newV) throws IOException
    {
        ...
        Descriptor descNew = new Descriptor(format.getVersion(newV), FileUtils.getTempDir(), "test", "test_new", new SequenceBasedSSTableId(0));
        Descriptor descOld = new Descriptor(format.getVersion(oldV), FileUtils.getTempDir(), "test", "test_old", new SequenceBasedSSTableId(1));
        File statsFileLb = serialize(originalMetadata, serializer, descNew);
        File statsFileLa = serialize(originalMetadata, serializer, descOld);
