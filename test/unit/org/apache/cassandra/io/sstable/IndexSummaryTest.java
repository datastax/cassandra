...
public class IndexSummaryTest
{
    ...
    private void testPosition(IndexSummary original, IndexSummary downsampled, List<DecoratedKey> keys)
    {
        ...
        {
            long orig = AbstractSSTableReader.getIndexScanPositionFromBinarySearchResult(original.binarySearch(key), original);
            int binarySearch = downsampled.binarySearch(key);
            int index = AbstractSSTableReader.getIndexSummaryIndexFromBinarySearchResult(binarySearch);
            int scanFrom = (int) AbstractSSTableReader.getIndexScanPositionFromBinarySearchResult(index, downsampled);
