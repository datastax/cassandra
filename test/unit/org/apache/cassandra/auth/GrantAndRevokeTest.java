...
public class GrantAndRevokeTest extends CQLTester
{
    ...
    public void testGrantOnAllKeyspaces() throws Throwable
    {
        ...
        */
        ...
        /* FIXME:  Modification is not supported by table system_views.peer_nodes
    ...
    {
        Set<String> readableKeyspaces = new HashSet<>(Arrays.asList(SchemaConstants.SCHEMA_KEYSPACE_NAME));
