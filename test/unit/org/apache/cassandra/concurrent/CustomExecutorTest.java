...
public class CustomExecutorTest
{
    ...
    private static final HashMap<String, LocalAwareExecutorPlus> executors = new HashMap<>();
    ...
    {
        @Override
        public LocalAwareExecutorPlus init(String jmxName, String jmxType, int numThreads, LocalAwareExecutorPlus.MaximumPoolSizeListener onSetMaximumPoolSize)
        {
            return executors.computeIfAbsent(jmxName, k -> new CustomExecutor(jmxName));
        }
    }

    public static class CustomExecutor implements LocalAwareExecutorPlus
    {
