...
public class SchemaComparisonBetweenSSTablesAndCQLTablesTest
{
    ...
    {
        ssTableMetadataForTableMap.put(
        TABLE_1_NAME,
        Util.metadataFromSSTable(
        Descriptor.fromFilename("src/resources/org/apache/cassandra/schema/schema_validation_tests/test_1-7ab21491848211ee825e31532694b0d3/bb-2-bti-Data.db"),
        encodedKeyspaceName, TABLE_1_NAME));

        ssTableMetadataForTableMap.put(
        TABLE_2_NAME,
        Util.metadataFromSSTable(
        Descriptor.fromFilename("src/resources/org/apache/cassandra/schema/schema_validation_tests/test_2-83ac0dd1848211ee825e31532694b0d3/bb-1-bti-Data.db"),
        encodedKeyspaceName, TABLE_2_NAME));

        ssTableMetadataForTableMap.put(
        TABLE_3_NAME,
        Util.metadataFromSSTable(
        Descriptor.fromFilename("src/resources/org/apache/cassandra/schema/schema_validation_tests/test_3-88b6cb80848211ee825e31532694b0d3/bb-1-bti-Data.db"),
        encodedKeyspaceName, TABLE_3_NAME));

        ssTableMetadataForTableMap.put(
        TABLE_4_NAME,
        Util.metadataFromSSTable(
        Descriptor.fromFilename("src/resources/org/apache/cassandra/schema/schema_validation_tests/test_4-8bf57bc0848211ee825e31532694b0d3/bb-1-bti-Data.db"),
        encodedKeyspaceName, TABLE_4_NAME));

        ssTableMetadataForTableMap.put(
        TABLE_5_NAME,
        Util.metadataFromSSTable(
        Descriptor.fromFilename("src/resources/org/apache/cassandra/schema/schema_validation_tests/test_5-9db47b90848211ee825e31532694b0d3/bb-1-bti-Data.db"),
    ...
    public void testIdenticalSchemaPassesValidation_SinglePartKeyNoClustering()
    {
        ...
        TableMetadata cqlTableMetadata =
        TableMetadata.builder(encodedKeyspaceName, TABLE_1_NAME, TableId.fromUUID(UUID.randomUUID()))
    ...
    public void testIdenticalSchemaPassesValidation_SinglePartKeySingleClusteringAsc()
    {
        ...
        TableMetadata cqlTableMetadata =
        TableMetadata.builder(encodedKeyspaceName, TABLE_2_NAME, TableId.fromUUID(UUID.randomUUID()))
                     .addPartitionKeyColumn("col_txt", UTF8Type.instance)
                     .addRegularColumn("col_int", Int32Type.instance)
    ...
    public void testIdenticalSchemaPassesValidation_CompoundPartKeySingleClusteringDesc()
    {
        ...
        TableMetadata cqlTableMetadata =
        TableMetadata.builder(encodedKeyspaceName, TABLE_3_NAME, TableId.fromUUID(UUID.randomUUID()))
                     .addPartitionKeyColumn("col_txt", UTF8Type.instance)
    ...
    public void testIdenticalSchemaPassesValidation_SinglePartKeyTwoClusteringAscDesc()
    {
        ...
        TableMetadata cqlTableMetadata =
        TableMetadata.builder(encodedKeyspaceName, TABLE_4_NAME, TableId.fromUUID(UUID.randomUUID()))
                     .addPartitionKeyColumn("col_txt", UTF8Type.instance)
    ...
    public void testIdenticalSchemaPassesValidation_ManyDataTypes()
    {
        ...
        TableMetadata cqlTableMetadata =
        TableMetadata.builder(encodedKeyspaceName, TABLE_5_NAME, TableId.fromUUID(UUID.randomUUID()))
                     .addPartitionKeyColumn("col_txt", UTF8Type.instance)
    ...
    public void testPartitionKeyMismatchFailsValidation_WrongColumn()
    {
        ...
        .isThrownBy(() -> ssTableMetadata.validateTableStructureCompatibility(cqlTableMetadata));
    }
