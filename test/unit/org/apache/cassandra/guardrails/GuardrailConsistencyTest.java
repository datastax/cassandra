...
{
    private static Set<String> disallowedWriteConsistencyLevels = new LinkedHashSet<>(Arrays.asList(
    ...
    public void setupTest()
    {
        ...
        disableConsistencyLevels(disallowedWriteConsistencyLevels);
    }
    ...
    {
        disableConsistencyLevels(new LinkedHashSet<>(Collections.singletonList(ConsistencyLevel.SERIAL.toString())));
    ...
    public void testInsertWithAllowedConsistency()
    {
        ...
        disableConsistencyLevels(new LinkedHashSet<>(Collections.singletonList(ConsistencyLevel.LOCAL_SERIAL.toString())));
