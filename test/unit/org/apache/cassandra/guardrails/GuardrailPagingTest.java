...
public class GuardrailPagingTest extends GuardrailTester
{
    ...
    /**
     * DSP-22813/DBPE-16245/DBPE-16378: Test that count(*) returns the correct number of rows, even if paging is
     * required. Before SP-22813/DBPE-16245/DBPE-16378 fix these queries would stop counting after hitting the
     * page_size_failure_threshold_in_kb guardrail, returning only the count of a single page.
     */
    @Test
