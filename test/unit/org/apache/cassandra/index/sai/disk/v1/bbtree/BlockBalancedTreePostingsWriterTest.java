...
public class BlockBalancedTreePostingsWriterTest extends SAIRandomizedTester
{
    ...
    public void shouldWritePostingsForEligibleNodes() throws Exception
    {
        ...
        long fp;
        try (IndexOutputWriter output = IndexFileUtils.instance.openPerIndexOutput(IndexComponent.POSTING_LISTS, indexDescriptor, indexContext))
        {
    ...
    {
        assertPostingReaderEquals(IndexFileUtils.instance.openPerIndexInput(IndexComponent.POSTING_LISTS, indexDescriptor, indexContext),
