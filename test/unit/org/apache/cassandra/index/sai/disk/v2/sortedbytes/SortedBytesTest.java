...
public class SortedBytesTest extends NdiRandomizedTest
{
    @Rule
    ...
    public void testLexicographicException() throws Exception
    {
        ...
        try (IndexOutputWriter trieWriter = comps.createOutput(comps.kdTree);
             IndexOutputWriter bytesWriter = comps.createOutput(comps.termsData);
             IndexOutputWriter blockFPWriter = comps.createOutput(comps.kdTreePostingLists))
        {
    ...
    public void testSeekToTerm() throws Exception
    {
        ...
        try (FileHandle trieHandle = comps.createFileHandle(comps.kdTree);
             IndexInput blockFPInput = comps.openBlockingInput(comps.kdTreePostingLists))
        {
        ...
        // iterate randomly
        try (FileHandle trieHandle = comps.createFileHandle(comps.kdTree);
             IndexInput bytesInput = comps.openBlockingInput(comps.termsData);
             IndexInput blockFPInput = comps.openBlockingInput(comps.kdTreePostingLists))
        {
            SortedBytesReader reader = new SortedBytesReader(meta,
                                                             trieHandle,
