...
import org.apache.cassandra.index.sai.disk.v2cc.bitpack.BlockPackedReader;
import org.apache.cassandra.index.sai.disk.v2cc.bitpack.MonotonicBlockPackedReader;
import org.apache.cassandra.index.sai.disk.v2cc.bitpack.NumericValuesMeta;
import org.apache.cassandra.index.sai.disk.v2cc.bitpack.NumericValuesWriter;
import org.apache.cassandra.index.sai.disk.io.IndexFileUtils;
import org.apache.cassandra.index.sai.disk.v2cc.LongArray;
import org.apache.cassandra.index.sai.disk.v2cc.MetadataSource;
import org.apache.cassandra.index.sai.disk.v2cc.MetadataWriter;
...
public class NumericValuesTest extends SAIRandomizedTester
{
    ...
    private void writeTokens(boolean monotonic, IndexDescriptor indexDescriptor, long[] array, LongFunction<Long> generator) throws Exception
    {
        ...
        long current = 0;
        try (MetadataWriter metadataWriter = new MetadataWriter(IndexFileUtils.instance.openPerSSTableOutput(IndexComponent.GROUP_META, indexDescriptor));
