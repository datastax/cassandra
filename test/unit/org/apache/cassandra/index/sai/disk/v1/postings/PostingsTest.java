...
public class PostingsTest extends SAIRandomizedTester
{
    ...
    public void testSingleBlockPostingList() throws Exception
    {
        ...
        IndexInput input = IndexFileUtils.instance.openPerIndexInput(IndexComponent.POSTING_LISTS, indexDescriptor, indexContext);
        ...
        input = IndexFileUtils.instance.openPerIndexInput(IndexComponent.POSTING_LISTS, indexDescriptor, indexContext);
    ...
    public void testMultiBlockPostingList() throws Exception
    {
        ...
        try (IndexInput input = IndexFileUtils.instance.openPerIndexInput(IndexComponent.POSTING_LISTS, indexDescriptor, indexContext))
        {
            SAICodecUtils.validate(input);
        }
