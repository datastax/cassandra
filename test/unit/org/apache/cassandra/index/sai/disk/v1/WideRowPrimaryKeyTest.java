...
public class WideRowPrimaryKeyTest extends AbstractPrimaryKeyTester
{
    ...
    public void randomTest() throws Throwable
    {
        ...
        PrimaryKey.Factory factory = Version.AA.onDiskFormat().primaryKeyFactory(Murmur3Partitioner.instance, compositePartitionMultipleClusteringAsc.comparator);
        ...
        for (PrimaryKey primaryKey : keys)
        {
            if (lastKey == null || lastKey.compareTo(primaryKey.partitionKey()) < 0)
            {
                ...
                writer.startPartition(lastKey, 0);
            }
