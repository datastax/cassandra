...
public class TermsDistributionTest
{
    ...
    private ByteComparable encodeAsDecimal(double value)
    {
        ...
        return v -> TypeUtil.asComparableBytes(TypeUtil.asIndexBytes(raw, DecimalType.instance), DecimalType.instance, v);
    }

    private ByteComparable encodeAsBigInt(long value)
    {
        ByteBuffer raw = IntegerType.instance.decompose(BigInteger.valueOf(value));
        return v -> TypeUtil.asComparableBytes(TypeUtil.asIndexBytes(raw, IntegerType.instance), IntegerType.instance, v);
    }
