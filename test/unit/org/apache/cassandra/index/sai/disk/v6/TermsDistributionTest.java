...
public class TermsDistributionTest
{
    ...
    {
        ByteSource bs = Int32Type.instance.asComparableBytes(Int32Type.instance.decompose(value), ByteComparable.Version.OSS41);
        return ByteBuffer.wrap(ByteSourceInverse.readBytes(bs));
    }

    private ByteBuffer encode(double value)
    {
        ByteSource bs = DoubleType.instance.asComparableBytes(DoubleType.instance.decompose(value), ByteComparable.Version.OSS41);
        return ByteBuffer.wrap(ByteSourceInverse.readBytes(bs));
    }

    private ByteBuffer encodeAsDecimal(double value)
    {
        ByteBuffer raw = DecimalType.instance.decompose(BigDecimal.valueOf(value));
        return TypeUtil.encode(raw, DecimalType.instance);
    }

    private ByteBuffer encodeAsBigInt(long value)
    {
        ByteBuffer raw = IntegerType.instance.decompose(BigInteger.valueOf(value));
        return TypeUtil.encode(raw, IntegerType.instance);
    }
