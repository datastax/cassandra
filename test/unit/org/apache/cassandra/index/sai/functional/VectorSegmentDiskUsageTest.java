...
public class VectorSegmentDiskUsageTest extends VectorTester.Versioned
{
    ...
    private static final int ROWS_PER_SEGMENT = 1500;
    private static final int FIRST_SEGMENT_DISTINCT_VECTORS = 1024;

    /**
     * Restricts the {@link VectorTester.Versioned} matrix to the versions and flags relevant here:
     * <ul>
     *   <li>EC and earlier — predates FusedPQ; exercises the plain-PQ path.</li>
    ...
    public void testOnHeapThenOffHeapSegmentDiskUsage()
    {
        ...
        // Build one ROWS_PER_SEGMENT-vector population and write it identically to both segments:
        // (ROWS_PER_SEGMENT - FIRST_SEGMENT_DISTINCT_VECTORS + 1) copies of repeatedVector followed
        // by (FIRST_SEGMENT_DISTINCT_VECTORS - 1) other vectors. This gives exactly 1024 distinct
        // vectors, the minimum needed to train the PQ that enables the off-heap path for segment 2.
        // Ending with distinct vectors also keeps maxOrdinal at ROWS_PER_SEGMENT-1 after duplicate
        // rows create holes.
