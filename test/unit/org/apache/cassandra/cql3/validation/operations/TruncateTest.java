...
public class TruncateTest extends CQLTester
{
    ...
    public void testTruncateUnknownTable() throws Throwable
    {
        ...
        try
        {
            ...
            TestTruncateStatementProvider.testTruncateStatement.execute(QueryState.forInternalCalls(), QueryOptions.DEFAULT, new Dispatcher.RequestTime(0L, 0L));
            fail("Expected TruncationException");
        }
        catch (TruncateException e)
        {
    ...
    public static class TestTruncateStatement extends TruncateStatement
    {
        ...
        {
            executeInvoked = true;
            return super.execute(state, options, requestTime);
        }
