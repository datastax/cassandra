...
/**
 * CQL-driven regression test for CASSANDRA-21469 ("TrieMemtable MemtableReclaimMemory AssertionError:
...
public class MemtableNegativeReleasedCQLReproTest extends CQLTester
{
    ...
    {
        StorageCompatibilityMode saved = DatabaseDescriptor.getStorageCompatibilityMode();
        if ("skiplist_sharded".equals(memtableClass))
        {
            ...
            for (int seed = 0; seed < 50; seed++)
            {
                ...
                for (int i = 0; i < 40; i++)
                {
                    ...
                    .as("memtable on-heap owns went NEGATIVE during overwrite/delete churn (memtable=%s, " +
                        ...
                        "allocated (CASSANDRA-21469)", memtableClass, seed, i)
        ...
        {
            DatabaseDescriptor.setStorageCompatibilityMode(saved);
        }
    }
