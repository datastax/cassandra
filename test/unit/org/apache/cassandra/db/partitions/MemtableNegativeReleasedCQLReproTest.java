 ...
 * <p>
 * Root cause: when {@link org.apache.cassandra.db.rows.BTreeRow}{@code .mergeRowBTrees} reconciles an update into a
 ...
 * <p>
 * Backport of OSS commit d30ac083b8118f2f80acbebf371fc584f7d7253d (CASSANDRA-21469).
 */
        ...
        for (int seed = 0; seed < 50; seed++)
        {
            ...
            for (int i = 0; i < 40; i++)
            {
                ...
                .as("memtable on-heap owns went NEGATIVE during overwrite/delete churn (seed=%d, mutation=%d) " +
                    "— the memtable reported releasing more on-heap memory than it allocated (CASSANDRA-21469 / HCD-534)",
                    seed, i)
