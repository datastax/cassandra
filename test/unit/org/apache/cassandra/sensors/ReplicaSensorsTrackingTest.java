...
public class ReplicaSensorsTrackingTest
{
    ...
    public void testSensorsTrackedForPaxosPrepareCallback() throws InterruptedException
    {
        ...
        PrepareCallback callback = new PrepareCallback(key, cfs.metadata(), targets.size(), ConsistencyLevel.ALL, 0);
    ...
    public void testSensorsTrackedForPaxosProposeCallback() throws InterruptedException
    {
        ...
        ProposeCallback callback = new ProposeCallback(cfs.metadata(), targets.size(), targets.size(), false, ConsistencyLevel.ALL, 0);
