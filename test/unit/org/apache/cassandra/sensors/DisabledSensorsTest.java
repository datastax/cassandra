...
public class DisabledSensorsTest
{
    ...
    {
        CassandraRelevantProperties.SENSORS_FACTORY.setString(SensorsTestUtil.NoOpRequestSensorsFactory.class.getName());
    ...
    @Test
    public void testSensorsForCounterMutationVerbHandler() throws WriteTimeoutException, IOException
    {
    ...
    public void testLWTSensors()
    {
        ...
        Commit commit = Commit.newPrepare(update.partitionKey(), store.metadata(), ballot);
    ...
    private static void handleCounterMutation(CounterMutation mutation) throws IOException
    {
