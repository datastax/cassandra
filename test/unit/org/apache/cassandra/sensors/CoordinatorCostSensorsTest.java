...
public class CoordinatorCostSensorsTest
{
    ...
    public void testCoordinatorAddsReadCostRangeRead()
    {
        ...
        double readCost = sensors.getSensor(Context.from(sensors), Type.READ_COST).get().getValue();
        assertThat(readCost).as("READ_COST must equal READ_BYTES").isEqualTo(readBytes);

        double totalCost = sensors.getSensor(Context.from(sensors), Type.TOTAL_COST).get().getValue();
        ...
        assertThat(SensorsRegistry.instance.getSensor(Context.from(sensors), Type.READ_COST))
                .isPresent()
                .hasValueSatisfying(s -> assertThat(s.getValue()).isEqualTo(readCost));
        assertThat(SensorsRegistry.instance.getSensor(Context.from(sensors), Type.TOTAL_COST))
                .isPresent()
    ...
    public void testCoordinatorAddsWriteCostSingleInsert()
    {
        ...
        double writeCost = sensors.getSensor(Context.from(sensors), Type.WRITE_COST).get().getValue();
        ...
        assertThat(SensorsRegistry.instance.getSensor(Context.from(sensors), Type.WRITE_COST))
                .isPresent()
