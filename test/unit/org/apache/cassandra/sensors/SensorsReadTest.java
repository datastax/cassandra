...
public class SensorsReadTest
{
    ...
    public void testMemtableRead()
    {
        ...
        assertSensorValueAndOutboundMessageCustomHeaderEquality();
    }
    ...
    public void testSinglePartitionReadCommand_AllowFiltering()
    {
        ...
        assertSensorValueAndOutboundMessageCustomHeaderEquality(request1Bytes + request2Sensor.getValue());
    }
    ...
    private void assertSensorValueAndOutboundMessageCustomHeaderEquality()
    {
        Sensor localSensor = getThreadLocalRequestSensor();
        assertThat(localSensor.getValue()).isGreaterThan(0);

        assertSensorValueAndOutboundMessageCustomHeaderEquality(localSensor.getValue());
    }

    private void assertSensorValueAndOutboundMessageCustomHeaderEquality(double sensorValue)
    {
        ...
        for (Message message : capturedOutboundMessages)
        {
            ...
            readBytesSum += bytesToDouble(message.header.customParams().get(Type.READ_BYTES.name()));
        }
        assertThat(readBytesSum).isEqualTo(sensorValue);
    }
