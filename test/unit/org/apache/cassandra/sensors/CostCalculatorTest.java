...
public class CostCalculatorTest
{
    ...
    @Test
    public void testReadCost_bytesDominateWhenExecutionTimeIsLow()
    {
        // baseline = 1 000 000 bytes/s, num_cores = 1, baseline_per_core = 1_000_000
        // read_bytes = 500 000, read_execution_time = 100 ms
        // normalized_bytes = 500_000 / 1_000_000 = 0.5
        // normalized_execution_time = 0.1
        // READ_COST = max(0.1, 0.5) * 4000 = 2000.0
    ...
    @Test
    public void testReadCost_executionTimeDominatesWhenBytesAreLow()
    {
        // baseline = 1 000 000 bytes/s, num_cores = 1, baseline_per_core = 1_000_000
        // read_bytes = 100 000, read_execution_time = 500 ms
        // normalized_bytes = 0.1, normalized_execution_time = 0.5
        // READ_COST = max(0.5, 0.1) * 4000 = 2000.0
        TestCostCalculator calc = new TestCostCalculator(1_000_000, 1_000_000, 1);
        requestSensors.registerSensor(context, Type.READ_BYTES);
        requestSensors.registerSensor(context, Type.READ_EXECUTION_TIME);
    ...
    @Test
    public void testReadCost_multipleCoresDivideBaseline()
    {
        // baseline = 4 000 000 bytes/s, num_cores = 4, baseline_per_core = 1_000_000
        // read_bytes = 500 000, read_execution_time = 100 ms
        // normalized_bytes = 500_000 / 1_000_000 = 0.5
        // normalized_execution_time = 0.1
        // READ_COST = max(0.1, 0.5) * 4000 = 2000.0
    ...
    @Test
    public void testReadCost_nullSensors_returnsZero()
    {
        TestCostCalculator calc = new TestCostCalculator(1_000_000, 1_000_000, 1);
    ...
    @Test
    public void testReadCost_nullContext_returnsZero()
    {
        TestCostCalculator calc = new TestCostCalculator(1_000_000, 1_000_000, 1);
    ...
    @Test
    public void testWriteCost_bytesDominateWhenExecutionTimeIsLow()
    {
        // baseline = 1 000 000, num_cores = 1, baseline_per_core = 1_000_000
        ...
        // WRITE_COST = max(0.2, 0.8) * 4000 = 3200.0
        TestCostCalculator calc = new TestCostCalculator(1_000_000, 1_000_000, 1);
    ...
    @Test
    public void testWriteCost_executionTimeDominatesWhenBytesAreLow()
    {
        // baseline = 1 000 000, num_cores = 1, baseline_per_core = 1_000_000
        ...
        // WRITE_COST = max(0.7, 0.05) * 4000 = 2800.0
        TestCostCalculator calc = new TestCostCalculator(1_000_000, 1_000_000, 1);
        requestSensors.registerSensor(context, Type.WRITE_BYTES);
        requestSensors.registerSensor(context, Type.INDEX_WRITE_BYTES);
        requestSensors.registerSensor(context, Type.WRITE_EXECUTION_TIME);
    ...
    @Test
    public void testWriteCost_indexWriteBytesAddedToWriteBytes()
    {
        // Verify that index_write_bytes are included in the total byte count.
        // baseline = 1 000 000, num_cores = 1, write_bytes = 400 000, index_write_bytes = 400 000,
        // write_execution_time = 0
        // total = 800 000, normalized_bytes = 0.8
        // WRITE_COST = 0.8 * 4000 = 3200.0
    ...
    @Test
    public void testWriteCost_multipleCoresDivideBaseline()
    {
        // baseline = 4 000 000, num_cores = 4, baseline_per_core = 1_000_000
        // write_bytes = 600 000, index_write_bytes = 200 000, write_execution_time = 200 ms
        // total_write_bytes = 800 000, normalized_bytes = 0.8, normalized_execution_time = 0.2
        // WRITE_COST = max(0.2, 0.8) * 4000 = 3200.0
        TestCostCalculator calc = new TestCostCalculator(4_000_000, 4_000_000, 4);
    ...
    @Test
    public void testWriteCost_nullSensors_returnsZero()
    {
        TestCostCalculator calc = new TestCostCalculator(1_000_000, 1_000_000, 1);
    ...
    @Test
    public void testWriteCost_nullContext_returnsZero()
    {
        TestCostCalculator calc = new TestCostCalculator(1_000_000, 1_000_000, 1);
