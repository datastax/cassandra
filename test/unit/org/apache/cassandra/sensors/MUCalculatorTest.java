...
public class MUCalculatorTest
{
    ...
    @Test
    public void testRMU_bytesDominateWhenExecutionTimeIsLow()
    {
    ...
    @Test
    public void testRMU_executionTimeDominatesWhenBytesAreLow()
    {
        // baseline = 1 000 000 bytes/s, num_cores = 1, baseline_per_core = 1_000_000
    ...
    @Test
    public void testRMU_multipleCoresDivideBaseline()
    {
    ...
    @Test
    public void testWMU_bytesDominateWhenExecutionTimeIsLow()
    {
    ...
    @Test
    public void testWMU_executionTimeDominatesWhenBytesAreLow()
    {
        // baseline = 1 000 000, num_cores = 1, baseline_per_core = 1_000_000
    ...
    @Test
    public void testWMU_multipleCoresDivideBaseline()
    {
