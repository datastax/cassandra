...
public class RangeCommandIteratorTest
{
    ...
    public void testRangeQueried()
    {
        ...
        RangeCommandIterator data = RangeCommandIterator.create(replicaPlans, command, 1, 1000, vnodeCount, Dispatcher.RequestTime.forImmediateExecution());
        ...
        data = RangeCommandIterator.create(replicaPlans, command, vnodeCount, 1000, vnodeCount, Dispatcher.RequestTime.forImmediateExecution());
        ...
        replicaPlans = replicaPlanIterator(keyRange, keyspace, false);
        data = RangeCommandIterator.create(replicaPlans, command, 1, 1, vnodeCount, Dispatcher.RequestTime.forImmediateExecution());
        ...
        data = RangeCommandIterator.create(replicaPlans, command, 1, 1000, vnodeCount, Dispatcher.RequestTime.forImmediateExecution());
        verifyRangeCommandIterator(data, rows, 1, vnodeCount);
