...
public class RangeCommandIteratorTest
{
    ...
    public void testRangeQueried()
    {
        ...
        RangeCommandIterator data = RangeCommandIterator.create(replicaPlans, command, 1, 1000, vnodeCount, Dispatcher.RequestTime.forImmediateExecution(), ReadTracker.NOOP);
        ...
        data = RangeCommandIterator.create(replicaPlans, command, vnodeCount, 1000, vnodeCount, Dispatcher.RequestTime.forImmediateExecution(), ReadTracker.NOOP);
        ...
        replicaPlans = replicaPlanIterator(keyRange, keyspace, false);
        data = RangeCommandIterator.create(replicaPlans, command, 1, 1, vnodeCount, Dispatcher.RequestTime.forImmediateExecution(), ReadTracker.NOOP);
        ...
        data = RangeCommandIterator.create(replicaPlans, command, 1, 1000, vnodeCount, Dispatcher.RequestTime.forImmediateExecution(), ReadTracker.NOOP);
        verifyRangeCommandIterator(data, rows, 1, vnodeCount);
